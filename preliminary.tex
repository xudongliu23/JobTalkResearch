...
\frameT{Combinatorial Domains: Example}{
	...
	\begin{center}
			$\CD(V) = 
				...
				\langle\text{mvan, 6m, gray, }\ldots\rangle, \ldots\}}_{\text{\large $2^p$ outcomes, too many!}}$.
	\end{center}
...
\frameT{Research Problems of Interest}{
	\begin{enumerate}
		\item Preference representation formalisms to model qualitative preferences
					over combinatorial domains.
		\item Preference learning methods to cast preferences of agents in a formalism.
		\item Preference reasoning tasks:
		\begin{itemize}
			\item Dominance and optimization
			\item Manipulation: better off by misreporting preferences untruthfully.
		\end{itemize}
	\end{enumerate}
}
