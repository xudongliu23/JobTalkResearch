  ...
  \begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.95\textwidth}
      ...
      \begin{tikzpicture}[->,>=stealth',
        ...
        \node[main node,inner sep=2pt] (1) {M};
...
\frameT{Datasets}{
	\begin{figure}
		...
		\begin{tabular}{ |c||c|c|c|c| } 
			...
			\hline \hline
			BreastCancerWisconsin   & 9 & 270 & 9009 \\ 
			\hline
			CarEvaluation           & 6 & 1728 & 682721 \\ 
			\hline
			CreditApproval          & 10 & 520 & 66079 \\
			\hline
			GermanCredit            & 10 & 914 & 172368  \\
			\hline
			Ionosphere              & 10 & 118 & 3472 \\
			\hline
			MammographicMass        & 5 & 62 & 792 \\
			\hline
			Mushroom                & 10 & 184 & 8448 \\
			\hline
			Nursery                 & 8 & 1266 & 548064 \\
			\hline
			SPECTHeart              & 10 & 115 & 3196 \\
			\hline
			TicTacToe               & 9 & 958 & 207832 \\
			\hline
			Vehicle                 & 10 & 455 & 76713 \\
			\hline
			Wine                    & 10 & 177 & 10322 \\
			\hline
		\end{tabular}
